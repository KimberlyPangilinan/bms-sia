...
<h2 class="text-center pt-5">Barangay Culiat Management System | Request Panel</h2>
    <p class="datatable design text-center">Certificate of Residency Requests Form</p>
        ...
        <div class="col-md-7 pb-5">
            <div class="card mt-5">
              ...
              ?>
                ...
                <input type="hidden" class="form-control" name="no" value="<?php echo $row['id']; ?>">
                        <div class="row pb-3">
                        <div class="col">
                        ...
                        <input type="text" class="form-control" id="purposeField1" name="purpose" value="Certificate of Residency" readonly required>
                        </div>
                        </div>
                        ...
                        <div class="col">
                        <label for="puroknoField" class="form-label">Purok Number:</label>
                       <input type="text" class="form-control" id="puroknoField1" name="purokno" value="<?php echo $row['puroknumber']; ?>" readonly required>
                        </div>
                        <div class="col">
                       ...
                       <input type="text" class="form-control" id="contnoField1" name="contno" value="<?php echo $row['contno']; ?>" readonly required>
                        ...
                        <input type="text" class="form-control" id="snameField1" name="sname" value="<?php echo $row['lastname']; ?>" readonly required>
                        </div>
                        <div class="col">
                        <label for="fnameField" class="form-label">First Name: (Pangalan)</label>
                        <input type="text" class="form-control" id="fnameField1" name="fname" value="<?php echo $row['firstname']; ?>" readonly required>
                        </div>
                        <div class="col">
                        <label for="mnameField" class="form-label">Middle Name: (Gitnang Pangalan)</label>
                        <input type="text" class="form-control" id="mnameField1" name="mname" value="<?php echo $row['middlename']; ?>" readonly required>
                        </div>
                        <div class="col">
                        ...
                        <input type="text" class="form-control" id="nationField1" name="nation" value="<?php echo $row['nationality']; ?>" readonly required>
                        </div>
                        <div class="col">
                        ...
                        <input type="text" class="form-control" id="occuField1" name="occu" value="<?php echo $row['occupation']; ?>" readonly required>
                        </div>                            
                        </div>
                        <!-- End of 4th Section --> 
                        <?php     
            ...
            ?>
                        ...
                        <div class="row pb-3">
                        <div class="col">
                            <label for="reasonField1" class="form-label">Reason</label>
                        ...
                        <a href="../../../CuliatBMS/services/index.php" class="nav-link"><button type="button" class="btn btn-secondary">Return</button></a>
                        </div>
                    </form>
