...
<h2 class="text-center pt-5">Barangay Culiat Management System | Request Panel</h2>
    <p class="datatable design text-center">Certificate of Indigency Requests Form</p>
            ...
            <div class="card mt-5">
              ...
              ?>
                ...
                <input type="hidden" class="form-control" name="no" value="<?php echo $row['id']; ?>">
                        ...
                        <input type="text" class="form-control" id="purposeField1" name="purpose" value="Certificate of Indigency" readonly required>
                        </div>
                        </div>
