  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0">Manage Residents</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
              <div class="card-header">   
                  <span >
                     <a href="#addnew" data-toggle="modal" class="btn btn-success btn-sm btn-flat float-left "><i class="fa fa-plus"></i> New</a>
                  </span>  
