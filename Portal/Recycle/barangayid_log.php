  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0">Barangay ID Log</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Barangay ID Log</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
          <div class="col-12 ">
              <div class="card-header">   
                     <a href="../CuliatBMS/services/bgyid/barangayid.php"><button class="btn-success btn-sm btn-flat float-left"><i class="fa fa-plus"></i> Request New</button></a>
                </div>
                <div class="card-body">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = "SELECT * FROM bmss WHERE residentid='$id' AND status='Pending' AND purpose='Barangay ID'";
