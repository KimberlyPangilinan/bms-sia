...
<head>
  ...
  <title>Barangay Culiat | WEB PORTAL</title>
...
<body>
    ...
    <div class="pic"><img src="assets/img/team/LOGO.png" class="img-fluid" alt="" style="width:55px; height:55px; margin-right:10px;"></div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link   scrollto" href="#pricing"><span>E-Services</span></a></li>
          ...
          <li><a href="home.php" class="getstarted scrollto" style="background-color: #37517e"><?php echo  $_SESSION['firstname']."'s "; ?>Dashboard</a></li><?php } 
         
          else { ?>
          <li><a href="index.php" class="getstarted scrollto" style="background-color: #37517e">Log in</a></li><?php } ?>
        </ul>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" style="background-image: url('assets/img/Culiat1.png');" class="d-flex align-items-center">
 ...
 <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>E-Services</h2>
          <p>E-Services are services which make use of informtion and communication technologies.</p>
        </div>
      ...
      <div class="box">
      <center><h3>Requesting</h3></center>
              <ul>
                <li><i class="bx bx-check"></i> Barangay Document</li>
                <li><i class="bx bx-check"></i> Barangay ID</li>
                <li><i class="bx bx-check"></i> Tracker</li>
                
                <?php 
          if (isset($_SESSION['residentid'])){ ?>
          
          <li></li><a href="../CuliatBMS/services/index.php"><button type="submit" class="button btn">More</button></a></li>
          <?php } 
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          <div class="box" >
          <center><h3>Health Related</h3>
               <ul>
                <li><i class="bx bx-check"></i> Health Monitoring</li>
                <li><i class="bx bx-check"></i> Covid-19 and Booster</li>
                <li><i class="bx bx-check"></i> Contact Tracing</li>

                <?php 
          if (isset($_SESSION['residentid'])){ ?>
          
          <li></li><a href="../Health/home.php"><button type="submit" class="button btn">More</button></a></li>
          <?php } 
 ...
 <section id="portfolio" class="portfolio">
   ...
   <section id="team" class="team section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <?php
      	  include 'includes/conn.php';
          $sql = "SELECT * FROM webofficial ORDER BY position ASC";
          $query = $conn->query($sql);
          while($row = $query->fetch_assoc()){                        
        ?> 
          <div class="col-lg-6">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="<?php echo (!empty($row['photo'])) ? 'images/'.$row['photo'] : 'images/profile.jpg'; ?>" style="height:175px; width:200px;" class="img-fluid" alt=""></div>
              <div class="member-info">
  ...
  <a href="chat-application/login.php" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
