...
<!-- Main Sidebar Container -->
  <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary sbg elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         <span class="nav-header text-center text-bold">Health Monitoring System</span>
          <li class="nav-header">MAIN</li>
          <li class="nav-item">
            <a href="../Health/home.php" class="nav-link">
          ...
          ?> 
          <li class="nav-item">
            <a href="..BMS/Health/monitor.php" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Health
              </p>
          ...
          <li class="nav-item">
            <a href="BMS/Health/CBResult.php" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Vaccine/Booster
              </p>
          ...
          <li class="nav-item">
            <a href="/Health/BMIResult.php" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                BMI
              </p>
    ...
    <!-- /.sidebar -->
      ...
      <a href="logout.php" class="btn btn-secondary hide-on-collapse pos-right"><i class="fas fa-sign-out-alt"></i></i></a> 
